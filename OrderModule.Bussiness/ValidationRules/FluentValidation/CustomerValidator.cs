...
namespace OrderModule.Bussiness.ValidationRules.FluentValidation
{
    public class CustomerValidator:AbstractValidator<Customer>
    {
        ...
        { 
            ...
            RuleFor(p => p.CustomerID).MaximumLength(5).WithMessage("Şirket Kodu 5 karekterden uzun olamaz.");
            RuleFor(p => p.CompanyName).MaximumLength(40).WithMessage("Şirket ismi 40 karakterden uzun olamaz.");
            RuleFor(p => p.ContactName).MaximumLength(30).WithMessage("Kişi ismi 30 karakterden uzun olamaz.");
            RuleFor(p => p.ContactTitle).MaximumLength(30).WithMessage("Kişi unvanı 30 karakterden uzun olamaz.");
            ...
            RuleFor(p => p.Country).MaximumLength(15).WithMessage("Şehir 15 karakterden uzun olamaz.");
            RuleFor(p => p.Phone).MaximumLength(24).WithMessage("Telefon numarasi 24 karakterden uzun olamaz.");
            RuleFor(p => p.Fax).MaximumLength(24).WithMessage("Fax 24 karakterden uzun olamaz.");
